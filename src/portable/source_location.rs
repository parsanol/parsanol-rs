...
impl SourceSpan {
    ...
    /// Create a span covering a range with explicit line/column values
    ///
    /// This is a convenience method for creating spans when you already know
    /// the line and column values.
    pub fn range(
        start_offset: usize,
        end_offset: usize,
        start_line: usize,
        ...
        Self {
            start: SourcePosition::new(start_offset, start_line, start_column),
            end: SourcePosition::new(end_offset, end_line, end_column),
        }
    }
...
impl<'a> SourceContext<'a> {
    ...
    pub fn format_with_underline(&self) -> String {
        ...
        let relative_offset = self
            .position
            .offset
            .saturating_sub(self.context_start_offset);
